...
router.route('multiply-left', (ctx) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    ...
    yield ctx.reply('Please provide the next number to multiply.');
}));
router.route('multiply-right', (ctx) => __awaiter(void 0, void 0, void 0, function* () {
    var _b;
    ...
    ctx.session.route = '';
    yield ctx.reply(`The result of multiplying the numbers is \
